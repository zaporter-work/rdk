...
func setupBaseChannels(t *testing.T) (client *baseChannel, server *baseChannel, clientDone <-chan struct{}, serverDone <-chan struct{}) {
	logger := golog.NewTestLogger(t)
...
func TestBaseChannel(t *testing.T) {
	...
	bc1, bc2, peer1Done, peer2Done := setupBaseChannels(t)
